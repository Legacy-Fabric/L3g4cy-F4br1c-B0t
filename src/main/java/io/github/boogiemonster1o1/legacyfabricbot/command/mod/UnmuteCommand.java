...
public class UnmuteCommand extends ModCommand {
	public UnmuteCommand(LiteralCommandNode<MessageCreateEvent> node) {
		super(node);
	}

	public static void register(CommandManager commandManager) {
		LiteralCommandNode<MessageCreateEvent> node = literal("unmute")
				.then(
		...
		commandManager.register(new UnmuteCommand(node));
	}
}
